! function (t, n) {
    ...
    return function (t) {
        ...
        var c = "undefined" != typeof window && window.navigator && window.navigator.platform && (/iP(ad|hone|od)/.test(window.navigator.platform) || "MacIntel" === window.navigator.platform && window.navigator.maxTouchPoints > 1),
            ...
            v = function () {
                setTimeout((function () {
                    void 0 !== l && (document.body.style.paddingRight = l, l = void 0), void 0 !== f && (document.body.style.overflow = "visible", f = void 0)
                }))
            },
            h = function (t, n) {
                if (c) {
                    ...
                    ! function (t) {
                        setTimeout((function () {
                            ...
                            void 0 === f && (f = document.body.style.overflow, document.body.style.overflow = "visible")
                        }))
                    }(n);
                    var i = {
                        targetElement: t,
